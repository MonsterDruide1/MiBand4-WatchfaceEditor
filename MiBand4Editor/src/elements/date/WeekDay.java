...
public class WeekDay extends Element{

	ImageSet set;
	
	public WeekDay(int x, int y, int imageIndex, int imageCount, boolean ignoreDimension) throws UnequalDimensionsException, IOException{
